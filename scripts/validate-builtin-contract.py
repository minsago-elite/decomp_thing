...
EXPECTED = {
    ...
    "decompengine.agent.AgentSessionJournalTest": 12,
    ...
    "decompengine.builtin.BuiltinRepairJournalFactoryTest": 6,
    "decompengine.builtin.BuiltinRepairPersistenceTest": 7,
...
def main():
    ...
    verdict = {
        "schemaVersion": 1, "corpus": "builtin-core-contract-v12",
