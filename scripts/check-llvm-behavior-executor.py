#!/usr/bin/env python3
"""Check whether this host matches the locked Clang behavior executor profile."""
...
from oracle.llvm.behavior_corpus import verify_llvm_executor_profile  # noqa: E402
