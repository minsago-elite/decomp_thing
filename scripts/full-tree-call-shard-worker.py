...
def main() -> int:
    ...
    try:
        ...
        return 1
    print(json.dumps({"entities": entities, "maximumResidentBytes": maximum_resident_bytes, "systemCpuSeconds": usage.ru_stime, "userCpuSeconds": usage.ru_utime}, sort_keys=True, separators=(",", ":")))
    return 0
