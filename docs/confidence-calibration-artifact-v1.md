...
validation identities, contiguous score bands covering `[0, 1]`, and partition totals.
...
Wilson 95% interval are the supporting check. Fit and validation samples must have distinct
hashes.
...
the benchmark revision and input, target ABI, oracle, score definition and dimension, plus
