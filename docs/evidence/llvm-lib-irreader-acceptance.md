# `llvm-lib-irreader` acceptance evidence

This checkpoint records the authenticated source ownership boundary for issue
#1032. It is evidence for the bounded planning slice only; it does not claim
that an implementation has been generated, accepted, merged, or qualified for
production.

## Authenticated population

The LLVM 22.1.6 inventories bind exactly one linked handwritten compilation
unit to this shard:

| Module/unit ID | Source path | Raw path SHA-256 |
| --- | --- | --- |
| `cu-b603568e0c82d45154f3de7e3c230cbb` | `source/llvm/lib/IRReader/IRReader.cpp` | `24112959acaa45c0c74bb382a5eef820ea464017b2b14521ad6f92d8b24c76ef` |
...
therefore remains unresolved and release-blocking under #1032. Placeholder,
