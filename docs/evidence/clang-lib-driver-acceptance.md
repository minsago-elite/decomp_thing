...
control test asserts the complete ordered source-path population, module-to-unit
identity binding, handwritten classification, shard ownership, and the one
source-only record:
