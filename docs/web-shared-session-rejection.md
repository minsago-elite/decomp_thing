...
The final follow-up report covers the rebuilt merge through master `653d3754`, including the activity receipt-age fix at the shared polling/SSE acceptance point. All 351 frontend tests, lint, build, 298 selected JVM tests, distZip and the packaged browser journey passed. The earlier pre-merge browser report is retained separately.
