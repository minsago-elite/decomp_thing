...
internal class WebArchiveEvidence(private val store: JobStore, private val sources: WebSourceEvidence,
    ...
    fun read(jobId: String, expectedSha256: String? = null, reportPrefix: String = "reports"): WebArchiveSnapshot {
        ...
        val inventory = store.sourceArchiveInventory(jobId, reportPrefix, transport.excludedOutputRoots)
        ...
        try {
            ...
            require(inventory == store.sourceArchiveInventory(jobId, reportPrefix, transport.excludedOutputRoots)) { "archive source inventory changed during verification" }
