...
def render_full_tree_release_summary(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"| Unique non-emitted functions | {function['nonEmittedUnique']:,} |",
        f"| Inline-only functions | {function['inlineOnlyUnique']:,} |",
        f"| COMDAT/ODR selected elsewhere | {function['selectedElsewhereUnique']:,} |",
        f"| Coalesced emitted RVAs | {function['coalescedEmittedRvas']:,} |",
